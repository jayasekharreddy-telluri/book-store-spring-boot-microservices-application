...
import com.jailabs.order_service.domain.models.*;
...
public class OrderService {
    ...
    public CreateOrderResponse createOrder(String userName, CreateOrderRequest request) throws InterruptedException {
