...
import com.jailabs.order_service.clients.catalog.Product;
import com.jailabs.order_service.clients.catalog.ProductServiceClient;
...
class OrderValidator {
    ...
    void validate(CreateOrderRequest request) throws InterruptedException {
